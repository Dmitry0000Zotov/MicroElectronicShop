...
{
    public class ApplicationItemsController : Controller
    {
        private readonly IApplicationItemService _applicationItemService;
        public ApplicationItemsController(IApplicationItemService applicationItemService)
        {
            _applicationItemService = applicationItemService;
        }

        public async Task<IActionResult> MyApplicationItems()
        {
